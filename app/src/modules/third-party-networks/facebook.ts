...
@Component({
  ...
  outputs: ['done'],
  template: `<div class="mdl-spinner mdl-js-spinner is-active" [mdl] [hidden]="!inProgress"></div>
...
<div class="setup" *ngIf="!page && !inProgress">
  ...
  <b *ngIf="accounts.length > 0" class="mdl-color-text--blue-grey-400" style="text-align: center; margin: 0; display:block;">
    Select a page to link below</b>
